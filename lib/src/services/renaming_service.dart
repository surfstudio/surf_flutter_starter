...
class RenamingService {
  ...
  Future<void> renameProject({
    ...
    _directoryService.updateDirectory(
      directoryPath:
          '$executablePath\\$templateProjectNameMain'.replacePathSeparators(),
      newName: projectName,
    );
  ...
  Future<void> renameAndroid({
    ...
    String mainManifestContent = _directoryService.readFileAsString(
        filePath: '$fullPath\\${ProjectPath.androidMainManifestPath}'
            .replacePathSeparators());
    mainManifestContent =
        mainManifestContent.replaceAll(_oldPackageID, bundleId);
    mainManifestContent =
        mainManifestContent.replaceAll(_oldAppLabel, appLabel);
    ...
    String debugManifestContent = _directoryService.readFileAsString(
        filePath: '$fullPath\\${ProjectPath.androidDebugManifestPath}'
            .replacePathSeparators());
    debugManifestContent =
        debugManifestContent.replaceAll(_oldPackageID, bundleId);
    _directoryService.updateFile(
        filePath: '$fullPath\\${ProjectPath.androidDebugManifestPath}'
            .replacePathSeparators(),
    ...
    String profileManifestContent = _directoryService.readFileAsString(
        filePath: '$fullPath\\${ProjectPath.androidProfileManifestPath}'
            .replacePathSeparators());
    profileManifestContent =
        profileManifestContent.replaceAll(_oldPackageID, bundleId);
    _directoryService.updateFile(
        filePath: '$fullPath\\${ProjectPath.androidProfileManifestPath}'
            .replacePathSeparators(),
    ...
    String gradleContent = _directoryService.readFileAsString(
        filePath: '$fullPath\\${ProjectPath.androidAppGradlePath}'
            .replacePathSeparators());
    ...
    String kotlinContent = _directoryService.readFileAsString(
        filePath:
            '$fullPath\\${ProjectPath.oldKotlinPath}'.replacePathSeparators());
    ...
    _directoryService.deleteDirectory(
        directoryPath:
            '$fullPath\\${ProjectPath.oldIDPath}'.replacePathSeparators());
  ...
  Future<void> renameIOS({
    ...
    String infoPlistContent = _directoryService.readFileAsString(
        filePath: '$fullPath\\${ProjectPath.iosInfoPlistPath}'
            .replacePathSeparators());
    ...
    String infoConfigContent = _directoryService.readFileAsString(
        filePath:
            '$fullPath\\${ProjectPath.iosCommonPath}'.replacePathSeparators());
